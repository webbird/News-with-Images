 ...
 * @filesource      $HeadURL: modules/news_img/modify_comment.php $
...
$query_content = $database->query("SELECT post_id,title,comment FROM ".TABLE_PREFIX."mod_news_img_comments WHERE comment_id = '$comment_id'");
...
<form name="modify" action="<?php echo WB_URL; ?>/modules/news_img/save_comment.php" method="post" style="margin: 0;">
...
<tr>
	...
	<td align="right">
		<input type="button" value="<?php echo $TEXT['CANCEL']; ?>" onclick="javascript: window.location = '<?php echo WB_URL; ?>/modules/news_img/modify_post.php?page_id=<?php echo $page_id; ?>&amp;section_id=<?php echo $section_id; ?>&amp;post_id=<?php echo $fetch_content['post_id']; ?>';" style="width: 100px; margin-top: 5px;" />
	</td>
</tr>
</table>
</form>
